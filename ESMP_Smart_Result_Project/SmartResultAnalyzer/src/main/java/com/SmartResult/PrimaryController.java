...
//        style1.setFont(font1); 
    	...
    	cellnum=2;
    	XSSFCell cell1 = row0.createCell(cellnum++); 
...
//    }
    	...
    	cellnum=0;
        XSSFCell cell0 = row0.createCell(cellnum++); 
...
//             sem2=false; 
    ...
    public static void putSubjectData(XSSFWorkbook workbook,String[] studentdata, XSSFSheet sheet, XSSFRow row,int cellno,int y,int sem1,int sem2m)
    { 
    	 XSSFCellStyle style = workbook.createCellStyle();
          //style.setFillForegroundColor(IndexedColors.TURQUOISE .getIndex());  
...
//       System.out.println("herecell"+k);
       for(int i=0;i<n;i++){
           XSSFCell cell = row.createCell(x-1);
...
//           XSSFCell cell1 = row2.createCell(x-2);
...
//         System.out.println("itop="+itop);
           XSSFCell cell1 = row2.createCell(x-1);
...
//         }
       ...
       XSSFRow row4=sheet.createRow(rownum+4); 
       XSSFRow row5=sheet.createRow(rownum+5); 
       XSSFCell cell = row.createCell(x-1);
       cell.setCellValue("Count");
       XSSFCell cell1 = row1.createCell(x-1);
       cell1.setCellValue("Total:");
        XSSFCell cell2 = row2.createCell(x-1);
       cell2.setCellValue("FF:");
        XSSFCell cell3 = row3.createCell(x-1);
       cell3.setCellValue("Pass:");
        XSSFCell cell4 = row4.createCell(x-1);
       cell4.setCellValue("Failure %");
        XSSFCell cell5 = row5.createCell(x-1);
...
//         Row row2=sheet.getRow(6);
          ...
          XSSFCell cell=row.createCell(cellno1++);
...
//        cell.setCellValue("T");
      ...
      public static void putOverAlldata(XSSFWorkbook workbook, XSSFSheet sheet,XSSFSheet sheet1,int year,int n1){
         ...
         XSSFRow row1=sheet.getRow(rownum);
          XSSFRow row=sheet1.getRow(rownum1++); 
//           System.out.println();
          XSSFCell cell=row.createCell(cellno1);
